...
task=2025-05-06-07-v3.0-success-only-weblab_the_oven-bottle #TODO
...
#output_dir="./my_outputs/hsr/${task}/steps-${steps}_bsz-${batch_size}_workers-${num_workers}_gpu-${num_gpus}_compile-None"
output_dir="./my_outputs/hsr/${task}/steps-${steps}_bsz-${batch_size}_workers-${num_workers}_gpu-${num_gpus}_lr-${lr}_compile-None_hz-${hz}-resume" #TODO
...
(time python scripts/gr00t_finetune_ep_pa.py \
    ...
    --base_model_path /home/group_25b505/group_6/workspace/user_00031_25b505/Isaac-GR00T/my_outputs/hsr/2025-05-06-07-v3.0-success-only-weblab_the_oven-bottle/steps-100000_bsz-128_workers-32_gpu-4_lr-1e-4_compile-None_hz-10/checkpoint-100000 \
