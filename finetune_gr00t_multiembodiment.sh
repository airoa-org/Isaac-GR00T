...
task=cross-embodiment #TODO
#task=2025-07-v3.0 #TODO
dataset_dir1=/home/group_25b505/group_6/workspace/user_00077_25b505/SimplerEnv/Isaac-GR00T/input/google_data_InternData/InternData-fractal20220817_data
dataset_dir2=/home/group_25b505/group_6/workspace/user_00077_25b505/SimplerEnv/Isaac-GR00T/input/widowx_data_InternData/InternData-BridgeV2
#dataset_dir1=/home/group_25b505/dataset/hsr/processed/2025-05-06-07-v3.1-success-only
embodiment1=google_robot
embodiment2=widowx
#steps=2000000
steps=60000
#steps=100000
...
#(time python scripts/gr00t_finetune.py \
(time python scripts/gr00t_finetune_ep_pa_xe.py \
    --output_dir ${output_dir} \
    --video_backend torchvision_av \
    --data_config ${embodiment1} ${embodiment2}\
    --dataset_path ${dataset_dir1} ${dataset_dir2}\
    --num-gpus ${num_gpus} \
    ...
    --learning_rate ${lr} \
    --embodiment_tag ${embodiment1} ${embodiment2}
