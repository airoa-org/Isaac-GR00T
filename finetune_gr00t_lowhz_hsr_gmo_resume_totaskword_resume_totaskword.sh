...
#output_dir="./my_outputs/hsr/${task}/steps-${steps}_bsz-${batch_size}_workers-${num_workers}_gpu-${num_gpus}_compile-None"
output_dir="./my_outputs/hsr/${task}/steps-${steps}_bsz-${batch_size}_workers-${num_workers}_gpu-${num_gpus}_lr-${lr}_compile-None_hz-${hz}-resume-toweblab-taskword-resume-toweblab-taskword" #TODO
