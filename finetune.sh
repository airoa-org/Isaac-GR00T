...
#task=2025-05-06-07-08-v3.0-success-only #TODO
task=2025-05-v3.0-success-only #TODO
#task=2025-07-v3.0 #TODO
dataset_dir1=/home/group_25b505/group_6/workspace/user_00085_25b505/projects/Isaac-GR00T/demo_data/2025-05-v3.0-success-only_reason
#dataset_dir2=/home/group_25b505/group_6/workspace/user_00085_25b505/data/hsr_2025-06-v3.0-success-only
#dataset_dir3=/home/group_25b505/group_6/workspace/user_00085_25b505/data/hsr_2025-07-v3.0-success-only
#dataset_dir4=/home/group_25b505/group_6/workspace/user_00085_25b505/data/hsr_2025-08-v3.0-success-only
...
#output_dir="./my_outputs/hsr/${task}/steps-${steps}_bsz-${batch_size}_workers-${num_workers}_gpu-${num_gpus}_compile-None"
output_dir="./my_outputs_reasoning/hsr/${task}/steps-${steps}_bsz-${batch_size}_workers-${num_workers}_gpu-${num_gpus}_lr-${lr}_compile-None_hz-${hz}" #TODO
