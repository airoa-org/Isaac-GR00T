...
dataset_dir1=/home/group_25b505/group_6/workspace/user_00085_25b505/projects/Isaac-GR00T/demo_data/2025-05-v3.0-success-only_weblab_the_oven-bottle
dataset_dir2=/home/group_25b505/group_6/workspace/user_00085_25b505/projects/Isaac-GR00T/demo_data/2025-06-v3.0-success-only_weblab_the_oven-bottle
dataset_dir3=/home/group_25b505/group_6/workspace/user_00085_25b505/projects/Isaac-GR00T/demo_data/2025-07-v3.0-success-only_weblab_the_oven-bottle
...
#output_dir="./my_outputs/hsr/${task}/steps-${steps}_bsz-${batch_size}_workers-${num_workers}_gpu-${num_gpus}_compile-None"
output_dir="./my_outputs/hsr/${task}/steps-${steps}_bsz-${batch_size}_workers-${num_workers}_gpu-${num_gpus}_lr-${lr}_compile-None_hz-${hz}-resume-toweblab-resume-toweblab-taskword" #TODO
...
(time python scripts/gr00t_finetune_ep_pa.py \
    --base_model_path /home/group_25b505/group_6/workspace/user_00031_25b505/Isaac-GR00T/my_outputs/hsr/2025-05-06-07-v3.0-success-only/steps-150000_bsz-32_workers-32_gpu-4_lr-1e-4_compile-None_hz-10-resume-toweblab/checkpoint-150000 \
    --sample_every_n ${sample_every_n} \
    --output_dir ${output_dir} \
    --video_backend torchvision_av \
    --data_config hsr_v21 \
    --dataset_path ${dataset_dir1} ${dataset_dir2} ${dataset_dir3} ${dataset_dir4}\
    --num-gpus ${num_gpus} \
