...
dataset_dir1=/home/group_25b505/group_6/workspace/user_00085_25b505/projects/Isaac-GR00T/demo_data/2025-05-v3.0-success-only_weblab
dataset_dir2=/home/group_25b505/group_6/workspace/user_00085_25b505/projects/Isaac-GR00T/demo_data/2025-06-v3.0-success-only_weblab
dataset_dir3=/home/group_25b505/group_6/workspace/user_00085_25b505/projects/Isaac-GR00T/demo_data/2025-07-v3.0-success-only_weblab
...
#output_dir="./my_outputs/hsr/${task}/steps-${steps}_bsz-${batch_size}_workers-${num_workers}_gpu-${num_gpus}_compile-None"
output_dir="./my_outputs/hsr/${task}/steps-${steps}_bsz-${batch_size}_workers-${num_workers}_gpu-${num_gpus}_lr-${lr}_compile-None_hz-${hz}-resume-toweblab-resume-toweblab" #TODO
